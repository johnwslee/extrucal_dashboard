                            ...
                            [
                                dbc.Col(
                                    [
                                        ...
                                        html.Br(),
                                        html.H5('절연 외경 [mm]'),
                                        dcc.Input(id='outer_d', type='number', value=10),
                                        html.Br(),
                                        html.Br(),
                                        html.H5('절연 두께 [mm]'),
                                        dcc.Input(id='thickness', type='number', value=2),
                                        html.Br(),
                                        html.Br(),
                                        html.H5('자재 상온 밀도 [kg/mm^3]'),
                                        dcc.Input(id='s_density', type='number', value=920),
                                        html.Br(),
                                        html.Br(),
                                        html.H5('자재의 용융/상온 밀도 비율'),
                                        dcc.Input(id='density_ratio', type='number', value=0.85),
                                        html.Br(),
                                        html.Br(),
                                        html.H5('최소 선속 [mpm]'),
                                        dcc.Input(id='min_l_speed', type='number', value=1),
                                        html.Br(),
                                        html.Br(),
                                        html.H5('최대 선속 [mpm]'),
                                        dcc.Input(id='max_l_speed', type='number', value=10),
                                        html.Br(),
                                        html.Br(),
                                        html.H5('선속 증가 단위'),
                                        dcc.Input(id='delta_l_speed', type='number', value=1),
                                        html.Br(),
                                        html.Br(),
                                        html.H5('최소 압출기 사이즈'),
                                        dcc.Input(id='min_size', type='number', value=40),
                                        html.Br(),
                                        html.Br(),
                                        html.H5('최대 압출기 사이즈'),
                                        dcc.Input(id='max_size', type='number', value=100),
                                        html.Br(),
                                        html.Br(),
                                        html.H5('압출기 사이즈 증가 단위'),
                                        dcc.Input(id='delta_size', type='number', value=5),
                                        html.Br(),
                                        html.Br(),
                                        html.H5('압출기 사이즈 대비 미터링 채널 깊이 비율'),
                                        dcc.Input(id='depth_percent', type='number', value=0.05),
                                    ],
                                    md=5
                                ),
                                dbc.Col(
...
@app.callback(
    ...
    Input('s_density', 'value'),
    Input('density_ratio', 'value'),
    Input('min_l_speed', 'value'),
    Input('max_l_speed', 'value'),
    Input('delta_l_speed', 'value'),
    Input('min_size', 'value'),
    Input('max_size', 'value'),
    Input('delta_size', 'value'),
    Input('depth_percent', 'value'),
)
def show_cable_plot(
